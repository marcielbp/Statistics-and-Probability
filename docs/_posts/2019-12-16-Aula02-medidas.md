...
==========
 ...
 Características importantes de qualquer conjunto de
dados\
 \
...
----
 ...
 A **moda** é o valor que ocorre com **maior frequência** em um
conjunto de dados\
 \
...
´ótimo bom bom péssimo bom bom ótimo ótimo bom ótimo bom ótimo bom bom ótimo bom péssimo bom péssimo bom péssimo bom bom bom bom ótimo bom péssimo ótimo ótimo bom péssimo´
...
-------
 ...
 A **mediana** é uma medida de centro que é o **valor do
...
seria a média aritmética das duas observações centrais.
 ...
 De maneira geral, a mediana de uma variável $X$ pode ser
definida por:
...
3, 4, 7, 8, 8 é $$\begin{aligned}
 ...
 Considere a nota das provas de 5 alunos em uma sala com 30
alunos
...
Note que a média é o **ponto de equilíbrio de massa** dos dados
 ...
 Considere o valor dos salários de todos os 6 empregados de uma
pequena empresa
...
Calcule a média populacional
 ...
 Agora, se tivermos $n$ observações da variável $X$, das quais
...
A média é calculada por: $$\begin{aligned}
 ...
 No caso de variáveis contínuas resumidas em tabelas de
...
- Medida não **resistente**
 ...
 Você está procurando um estágio nas empresas
...
Qual você escolheria?
 ...
 Para notar como a média é influenciada pela presença
de valores extremos
 ...
 **Exemplo**: Os dados abaixo se referem ao
...
===================
 ...
 O resumo de um conjunto de dados exclusivamente por uma
...
![image](figure/unnamed-chunk-2-1){width=".95\textwidth"}
 ...
 Cinco grupos de alunos se submeteram a um teste, obtendo
as seguintes notas
...
O que a média diz a respeito das notas quando comparamos os grupos?
 ...
 São medidas estatísticas que caracterizam o quanto um
...
---------
 ...
 A **amplitude** de um conjunto de dados é a diferença
...
 \
 ...
 Calcule a média e a amplitude do número de acertos em uma
...
`4 3 4 3 4 3 21`
 ...
 Para melhorar a medida de variabilidade, devemos
 ...
 **Grupo A** $x_i - \bar{x}$
 ...
 Como a soma dos desvios é **sempre** zero, temos
duas alternativas
...
------------
 ...
 O **desvio médio** é definido como a média aritmética
...
$\text{DM} = \frac{6}{5} = 1,2$
 ...
 Mas, o desvio médio é baseado em uma operação **não
...
---------
 ...
 A **variância** é definida como a *média aritmética* da
...
 \
 ...
 Assim como no caso da média, se tivermos $n$ observações
...
calculada por $$\begin{aligned}
 ...
 A variância amostral $s^2$ é considerada um estimador
 ...
 **Exemplo**: Os dados abaixo se referem ao percentual
...
-----------------------
 ...
 O **Coeficiente de Variação** (CV) mede a
...
comparar a variação de um ou mais conjuntos de dados
 ...
 Qual o Coeficiente de Variação para as duas
...
O que podemos concluir?
 ...
 O Coeficiente de Variação é muito útil
...
===========================
 ...
 Tanto a média como o desvio-padrão podem
...
Por isso, outras medidas podem ser consideradas.
 ...
 Vimos que a mediana é um valor que deixa
...
-------
 ...
 Quartis são medidas de posição, denotadas por
...
Calcule os quartis para os dois conjuntos de dados abaixo
 ...
 Os quartis são medidas são medidas de posição
...
se ter uma boa ideia da assimetria da distribuição dos dados.
 ...
 O resumo dos cinco números consiste no valor
...
### Box plots
 ...
 O box plot ou **gráfico de caixa**, é uma representação
...
4.  A partir de $Q_1$, faça uma linha para baixo até o ponto mais remoto
 ...
 Os valores compreendidos entre estes dois limites são
...
----------
 ...
 Exemplo: o tempo de espera, em minutos, para o
